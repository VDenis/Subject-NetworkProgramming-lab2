...
namespace DRssReader
{
    ...
    /// </summary>
    public sealed partial class MySearchResultsPage : DRssReader.Common.LayoutAwarePage
    {

        public MySearchResultsPage()
        {
        ...
        /// </summary>
        private sealed class Filter<T> : DRssReader.Common.BindableBase
        {
